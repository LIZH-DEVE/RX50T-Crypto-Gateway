...
if {[info exists ::env(RX50T_UART_ACL_PROBE_BUILD_DIR)] && $::env(RX50T_UART_ACL_PROBE_BUILD_DIR) ne ""} {
    set project_dir [file normalize $::env(RX50T_UART_ACL_PROBE_BUILD_DIR)]
} else {
    set project_dir [file normalize [file join $contest_root build rx50t_uart_acl_probe]]
}
...
set source_files [list \
    ...
    [file join $contest_root rtl contest contest_uart_acl_probe.sv] \
    [file join $contest_root rtl contest rx50t_uart_acl_probe_top.sv] \
    [file join $contest_root rtl contest rx50t_uart_acl_probe_board_top.sv] \
]
...
set sim_files [list [file join $contest_root tb contest tb_uart_acl_probe.sv]]
