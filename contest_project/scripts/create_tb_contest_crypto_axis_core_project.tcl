...
if {[info exists ::env(RX50T_CRYPTO_AXIS_SIM_DIR)] && $::env(RX50T_CRYPTO_AXIS_SIM_DIR) ne ""} {
    ...
    set project_dir [file normalize [file join $contest_root build sim_tb_contest_crypto_axis_core]]
}
...
add_files -fileset sim_1 -norecurse [list [file join $contest_root tb contest tb_contest_crypto_axis_core.sv]]
