...
create_project sim_tb_mac_facing_sustained_throughput [file normalize [file join $contest_root build sim_tb_mac_facing_sustained_throughput]] -part xc7a50tfgg484-1 -force
...
add_files -fileset sim_1 -norecurse [list [file join $contest_root tb contest tb_mac_facing_sustained_throughput.sv]]

set_property top tb_mac_facing_sustained_throughput [get_filesets sim_1]
