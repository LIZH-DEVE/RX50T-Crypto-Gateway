if {[info exists ::env(RX50T_ACL_V2_SIM_DIR)] && $::env(RX50T_ACL_V2_SIM_DIR) ne ""} {
    ...
    set project_dir [file normalize "D:/FPGAhanjia/jichuangsai/contest_project/build/sim_tb_uart_crypto_probe_acl_v2"]
}
...
add_files -fileset sim_1 -norecurse {
    D:/FPGAhanjia/jichuangsai/contest_project/tb/contest/tb_uart_crypto_probe_acl_v2.sv
}
