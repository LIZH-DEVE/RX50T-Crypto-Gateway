...
if {[info exists ::env(RX50T_UART_CDC_EGRESS_TOP_SIM_DIR)] && $::env(RX50T_UART_CDC_EGRESS_TOP_SIM_DIR) ne ""} {
    set project_dir [file normalize $::env(RX50T_UART_CDC_EGRESS_TOP_SIM_DIR)]
} else {
    set project_dir [file normalize [file join $contest_root build sim_tb_uart_crypto_probe_cdc_egress]]
}
file mkdir $project_dir

create_project sim_tb_uart_crypto_probe_cdc_egress $project_dir -part xc7a50tfgg484-1 -force
...
add_files -fileset sim_1 -norecurse [list \
    ...
    [file join $contest_root tb contest tb_uart_crypto_probe_cdc_egress.sv] \
]

set_property top tb_uart_crypto_probe_cdc_egress [get_filesets sim_1]
