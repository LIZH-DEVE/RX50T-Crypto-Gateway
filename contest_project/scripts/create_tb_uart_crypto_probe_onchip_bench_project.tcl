if {[info exists ::env(RX50T_ONCHIP_BENCH_SIM_DIR)] && $::env(RX50T_ONCHIP_BENCH_SIM_DIR) ne ""} {
    ...
    set project_dir [file normalize "D:/FPGAhanjia/jichuangsai/contest_project/build/sim_tb_uart_crypto_probe_onchip_bench"]
}
...
add_files -fileset sim_1 -norecurse {
    D:/FPGAhanjia/jichuangsai/contest_project/tb/contest/tb_uart_crypto_probe_onchip_bench.sv
}
