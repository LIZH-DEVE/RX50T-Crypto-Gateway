if {[info exists ::env(RX50T_WATCHDOG_SIM_DIR)] && $::env(RX50T_WATCHDOG_SIM_DIR) ne ""} {
    ...
    set project_dir [file normalize "D:/FPGAhanjia/jichuangsai/contest_project/build/sim_tb_uart_crypto_probe_watchdog"]
}
...
add_files -fileset sim_1 -norecurse {
    D:/FPGAhanjia/jichuangsai/contest_project/tb/contest/tb_uart_crypto_probe_watchdog.sv
}
